...
import { subtractDates } from "@/app/_lib/supabase";
...
function Uploader() {
  ...
  return (
    <div>
      <h3>SAMPLE DATA</h3>
      <button style={{ padding: "5px", background: "orangered" }} onClick={uploadAll}>
        Upload ALL
      </button>{" "}
      <button style={{ padding: "5px", background: "orangered" }} onClick={uploadBookings}>
